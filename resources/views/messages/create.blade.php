<x-app-layout>
    ...
    <div class="py-12">
        <div class="pp-content-wrap">
            ...
            lastSelectedQuery: '{{ old('recipient_name', $letter->recipient->name ?? request('to_name', '')) }}',
            results: [],
            open: false,
            search() {
                // Any manual edit invalidates the previous pick — require
                // re-selecting from the list rather than silently keeping
                // a recipient_id that no longer matches what's on screen.
