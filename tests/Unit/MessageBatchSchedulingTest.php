...
test('a message sent just after the monday noon utc cutoff waits an extra week', function () use ($mondayString) {
    $batch = Message::nextBatchFor(CarbonImmutable::parse("{$mondayString} 12:00:01", 'UTC'));
